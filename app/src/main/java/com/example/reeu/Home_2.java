...
import static com.example.reeu.R.id.lisMostrar2;
...
public class Home_2 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView=findViewById(lisMostrar2);
